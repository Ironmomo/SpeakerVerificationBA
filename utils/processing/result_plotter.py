...
# Path to csv data
results = '/home/fassband/ba/SpeakerVerificationBA/finetuning/exp/finetuned-20240510-160543-original-base-f128-t2-b48-lr1e-4-m390-finetuning_avg-asli/result.csv'
