...
OUTPUT_DIR = "/home/bosfab01/SpeakerVerificationBA/data/audioset_eval"
NUM_FILES = 9  # Total number of files you listed
MAX_WORKERS = 4  # Number of parallel download/processing tasks

if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)

def process_file(i):
    filename = f"eval{i:02}.tar"
    ...
    extraction_path = os.path.join(OUTPUT_DIR, f"eval{i:02}")
